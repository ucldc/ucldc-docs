...
More broadly, the UCLDC platform also supports a range of opportunities for co-development, leveraging the <a href="https://registry.cdlib.org/documentation/docs/technical/index/">suite of APIs</a> that are available.
...
Nuxeo supports batch exporting of metadata, with references to associated content files in Amazon S3, through its administrative user interface as well as <a href="https://registry.cdlib.org/documentation/docs/technical/nuxeo-api/">through its API</a>. Hence, we have flexible options for migrating content from Nuxeo to another platform.
