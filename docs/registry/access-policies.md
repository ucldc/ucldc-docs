...
All data harvested into the common index must include minimum metadata as specified by the [Metadata Harvesting Scheme]({{site.url}}{{site.baseurl}}/docs/registry/metadata-harvest/).
