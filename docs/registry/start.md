...
<div class="note"><p>The Collection Registry (<a href="http://registry.cdlib.org"http://registry.cdlib.org</a>) is an interface for content owners to define harvest targets for digital collections and to apply standardized information about campuses, institutions, and collections. Eventually, it may also support digital collection development and staging processes.</p></div>
