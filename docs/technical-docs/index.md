...
- [Common Index (Solr) API]({{ site.url }}{{ site.baseurl }}/docs/technical-docs/solr-api/) - The Solr index contains object level metadata only. Each record has collection and repository fields referencing collections and institutions in the Collection Registry. 
