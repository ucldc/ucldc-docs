...
## 2. What is the UCLDC shared DAMS?
...
## 3. Who can use and access the shared DAMS?
...
## 4. What kinds of resources can be managed in it?
...
## 6. What was the vision for a systemwide DAMS and where did it come from?
...
## 7. How was the UCLDC model determined and why was Nuxeo selected as the shared DAMS?
...
## 8. How long did it take to implement the DAMS and make it available to the Libraries?
...
## 9. What does Nuxeo offer the UC Libraries right now (September 2015)?
...
## 10. What does Nuxeo offer in the way of support for the Libraries?
...
## 11. What kind of metadata schemes does Nuxeo support?
...
## 12.  What are the technical components of Nuxeo?
...
## 13.  Are the metadata records and files (that are stored in Nuxeo) backed up?
...
## 14. Does Nuxeo/the current UCLDC stack support linked data?
...
## 15.  What plans are in place to enhance Nuxeo, to meet any additional or new use cases or requirements?
...
## 16. Does the shared DAMS and UCLDC allow for co-development or other collaboration opportunities with the campus libraries?
...
## 17. Does CDL plan to charge for use of the Nuxeo DAMS?
...
## 18. Is CDL exploring other options beyond Nuxeo?
...
## 19. If CDL and the Libraries decide to move to another platform for the shared DAMS, is there a strategy for migrating content out of Nuxeo to the new solution?
